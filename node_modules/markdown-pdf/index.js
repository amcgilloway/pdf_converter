...
function markdownpdf (opts) {
  ...
  // opts.imagePath = '/Users/allymcgilloway/courses/course_java/week_1/day_1/intelliJ_and_git'
  var md = ''
  ...
  var mdToHtml = through(
    ...
    function flush (cb) {
      ...
      var htmlCode = mdParser.render(md).replace(/<img src ?= ?"(\.\/)?/g, `<img src = "${opts.imagePath}/`);
      console.log(opts.imagePath);
